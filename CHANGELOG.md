...
- Documentation improvements: restructured README with badges and an API
  reference, sorted configuration options alphabetically, and clarified that
  field selection reduces payload size rather than credit usage.
- Releases are now published to npm through trusted publishing (OIDC) with
